...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
			...
			assertNull("Invalid cat ID." + newline, ret);
			assertEquals("Invalid cat ID." + newline, out.toString());
		} catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException e) {
			System.out.println("testGetCatNullNumCast0() failed!");
		}
	}
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			getCatmethod.setAccessible(true);
			Object ret = getCatmethod.invoke(r, 2);
			assertNotNull("Cat has an ID of 2", ret);
		} catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException e) {
			System.out.println("testGetCatNullNumCast0() failed!");
		}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("c2 should not be renamed to 'Garfield'", ret);
	...
	public void testRenameNumCat3() {
		...
		r.addCat(c3);
		boolean ret = r.renameCat(2, "Garfield");
		assertTrue("c2 should be renamed to 'Garfield'", ret);
	...
	public void testRentCatNumCats3() {
		...
		assertTrue("c2 should be rented.", ret);
	...
	public void testRentCatFailureNumCats3() {
		...
		boolean ret = r.rentCat(2);
		assertFalse("c2 should not be rented.", ret);
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("c2 should be returned", ret);
	...
	public void testReturnFailureCatNumCats3() {
		...
		assertFalse("c2 should be returned.", ret);
